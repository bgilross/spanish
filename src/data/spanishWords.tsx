	...
	verb: {
		...
		words: {
			estar: {
				...
				subjunctive: {
					este: {
						id: "verb.estar.subjunctive.este",
						word: "esté",
						translations: ["be", "I be", "he/she/it be"],
						pos: "Verb",
						tense: "Subjunctive",
						person: "first/third",
						info: [],
					...
					estes: {
						id: "verb.estar.subjunctive.estes",
						word: "estés",
						translations: ["be", "you be"],
						pos: "Verb",
						tense: "Subjunctive",
						person: "second",
						info: [],
					...
					estemos: {
						id: "verb.estar.subjunctive.estemos",
						word: "estemos",
						translations: ["be", "we be"],
						pos: "Verb",
						tense: "Subjunctive",
						person: "first plural",
						info: [],
					...
					esten: {
						id: "verb.estar.subjunctive.esten",
						word: "estén",
						translations: ["be", "they be"],
						pos: "Verb",
						tense: "Subjunctive",
						person: "third plural",
						info: [],
				...
				future: {
					estare: {
						id: "verb.estar.future.estare",
						word: "estaré",
						translations: ["will be", "I will be"],
						pos: "Verb",
						tense: "Future",
						person: "first",
						info: [],
					...
					estara: {
						id: "verb.estar.future.estara",
						word: "estará",
						translations: ["will be", "he/she/it will be"],
						pos: "Verb",
						tense: "Future",
						person: "third",
						info: [],
				...
				conditional: {
					estaria: {
						id: "verb.estar.conditional.estaria",
						word: "estaría",
						translations: ["would be", "I would be", "he/she/it would be"],
						pos: "Verb",
						tense: "Conditional",
						person: "first/third",
						info: [],
					...
					estarias: {
						id: "verb.estar.conditional.estarias",
						word: "estarías",
						translations: ["would be", "you would be"],
						pos: "Verb",
						tense: "Conditional",
						person: "second",
						info: [],
					...
					estariamos: {
						id: "verb.estar.conditional.estariamos",
						word: "estaríamos",
						translations: ["would be", "we would be"],
						pos: "Verb",
						tense: "Conditional",
						person: "first plural",
						info: [],
					...
					estarian: {
						id: "verb.estar.conditional.estarian",
						word: "estarían",
						translations: ["would be", "they would be"],
						pos: "Verb",
						tense: "Conditional",
						person: "third plural",
						info: [],
				...
				participle: {
					estado: {
						id: "verb.estar.participle.estado",
						word: "estado",
						translations: ["been"],
						pos: "Verb",
						tense: "Participle",
			...
			ser: {
				...
				subjunctive: {
					...
					seamos: {
						id: "verb.ser.subjunctive.seamos",
						word: "seamos",
						translations: ["be", "we be"],
						pos: "Verb",
						tense: "Subjunctive",
				...
				conditional: {
					seria: {
						id: "verb.ser.conditional.seria",
						word: "sería",
						translations: [
							"would be",
							"he/she/it/USTED would be",
							"I would be",
						],
						pos: "Verb",
						tense: "Conditional",
					...
					serian: {
						id: "verb.ser.conditional.serian",
						word: "serían",
						translations: ["would be", "they would be"],
						pos: "Verb",
						tense: "Conditional",
					...
					serias: {
						id: "verb.ser.conditional.serias",
						word: "serías",
						translations: ["would be", "you would be"],
						pos: "Verb",
						tense: "Conditional",
					...
					seriamos: {
						id: "verb.ser.conditional.seriamos",
						word: "seríamos",
						translations: ["would be", "we would be"],
						pos: "Verb",
						tense: "Conditional",
