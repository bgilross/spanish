...
const spanishData: { lessons: Lesson[] } = {
	lessons: [
		...
		},
		{
			...
			name: "Lesson 29",
			details:
				"El que, lo que, and la que vs que'. Ways to say 'What' and 'the one that'",
			info: [
				"This lesson we are learning more phrases that you can use as NOUNS, and the various ways you can say 'what' in Spanish when it's NOT part of a question:",
				"For example: 'I want WHAT he has'",
				"Firse let's learn a new adjective: BUENO/BUENA means GOOD!",
				"A tricky thing about this word Bueno is that it can EITHER come before or after the noun, for example: 'A good house' could either be 'una buena casa' OR 'una casa buena'",
				"Sometimes English speakers oversimplify by saying that in Spanish all ajdectives are supposed to go after nouns, but that is not true, some do, some don't, and some can do either",
				"As we learn more of them you will learn when to put which adjectives before or after nouns, remember that Bueno can do either.",
				"Consider this example using a masculine noun: 'a good boy' can be either: 'un chico bueno' OR 'un buen chico'",
				"But what happened to bueno here in the second example? For some reason, when BUENO is used before a masculine noun it loses the O at the end. This is unique to Buenoe, most adjectives don't do this.",
				"It's just another quirk to Bueno that you will have to get used to, obviously since BUENO can be used before or after nouns, you could simplify this by only using it after masculine nouns instead of before them",
				"BUENO/BUENA is generally used with SER because in Spanish this word for 'good' is normally considered part of something's identity, not HOW something is, but WHAT something is.",
				"For example: 'The house was good' = 'LA CASA ERA BUENA' or 'It's a good place' = 'ES UN BUEN LUGAR' OR 'ES UN LUGAR BUENO'",
				"BUENO / BUENA can be made plural simply by adding an S: EX: 'The boys were good' = 'LOS CHICOS ERAN BUENOS",
				"NOTE: BUENO is referring to the 'moral character' of the boys, it does not mean the boys were 'doing well', because remember BUENO is related to identity or WHAT something is, not HOW it is.",
				"If you want to say that something is 'doing good', or 'is well' or 'is doing well', not as WHAT something is, but HOW something is doing or feeling we use a different word: BIEN",
				"BIEN is an ADVERB as means literally 'well' as in doing 'well'. For example if someone asks you HOW you are doing you wouldn't say BUENO or BUENA you would likely say BIEN",
				"In english we might say we're doing 'fine' or 'OK' or 'GOOD' but in Spanish all these would translate as BIEN",
				"An easy test is if you would use 'good' in english see if it makes sense to use the word 'well' if it does use BIEN. EX: 'I feel good today' can also be 'I feel well today'",
				"Since BIEN is an adverb it is used simillarly to AQUI and it doesn't change forms based on who is doing well, it's always BIEN",
				"Now let's get into ways to say 'What' in spanish when it's not occuring as a question, to do that we need to talk about things you can do with ARTICLES.",
				"Spanish articles can be trated like NOUNS, by themselves, without requiring NOUNS or PRONOUNS",
				"Consider this sentence: 'I like the one that we saw yesterday', lets say we are talking about HOUSES, comparing different houses. I could have said 'I like the HOUSE that we saw yesterday' but instead I'm just saying 'the ONE that'",
				"In spanish you wouldn't say 'The one that' the word 'one' isn't used that way, instead the word 'one' is left out and you can just say 'the that'",
				"I like 'LA QUE' we saw yesterday",
				"Say we are talking about peopole, you met someone but don't remember his name: 'He was the one that was here' = 'ERA EL QUE ESTABA AQUI",
				"EL QUE and LA QUE are very frequently used in Spanish, and you will sound more like a Native speaker if you start using them all the time too, any time you would say 'the one that'",
				"Now we need to learn a new Article: LO, now LO is already a word for HIM/it as a direct object, but this Article LO is completely different, used in a different way and doesn't mean HIM and isn't Masculine.",
				"In this case LO, as an article, means THE, specifically meaning THE when there is no noun!",
				"This almost never happens in English, after saying THE in English we almost always use a noun, like this sentence: 'The good thing is that we're here'",
				"In Spanish, in sentences like that, we don't always use the word 'thing' there, instead we would say 'THE GOOD is that we're here', referring to 'the good' as an abstract non noun idea about what's good.",
				"In Spanish you COULD use the word THING which IS a noun in Spanish, but that's not idiomatic, or natural sounding to the language, Native speakers are more likely to use LO which lets you use THE without a noun.",
				"This creates a new Sentence template: 'LO [description] es que [sentence]'.",
				"Lo strange es que it’s snowing in May… lo terrible es que he won’t call me back, lo funny es que she was sleepwalking.",
				"How does LO relate to the earlie EL QUE and LA QUE examples? Is it possible to say LO QUE? YES! and it's actually a very common use of the article LO, for example: 'YO want LO QUE EL has?' = 'I want what he has' or literally 'I want THE that he has'",
				"So instead of using EL QUE for masculine item, or LA QUE for feminine item we can use LO QUE when there is no noun specified. In these cases 'LO QUE' translates as 'WHAT'",
				"Now you may be thinking we already learned the word for WHAT as QUE', but that's only used for QUESTIONS or EXLAMATIONS, LO QUE is used for WHAT when it's interchangeable with 'The one that'",
		...
		},
		{
			...
			name: "Lesson 32",
			details:
				"SER Future Tense and Unconjugated forms. SERÍA, SERÁ, SIDO, and SIENDO.",
			info: [
				"This lesson we will lean 5 new forms of SER, going beyond the present, past, and subjunctive, starting with the FUTURE tense",
				"We are only going to learn one conjugation for SER future tense, for now, and that is the third person: 'He/She/It/USTED will be' this is the only form that is very commonly used because there's actually a different way to put SER into the future which we will learn later.",
				"SERÁ means 'Will be' as in 'He will be', 'She will be', 'It will be', or the formal 'You(usted) will be'",
				"The next word we will learn is SERÍA which mean 'Would be'. Consider the sentence: 'I would be his friend', we aren't talking about the PAST, the PRESENT, or the FUTURE, instead we are using what is called the CONDITIONAL, meaning we are implying that something 'WOULD BE' the case if a particular condition is met.",
				"The fact is, there is no word in SPANISH for the ENGLISH word 'WOULD' so anytime you say that something 'WOULD BE' the case you use the CONDITIONAL conjugation, such as SERÍA",
				"This is one of the reasons there are so many conjugations of every verb in Spanish, in English we can just add the word WOULD to a sentence, but in Spanish you have to change the verb conjuagtion",
				"The CONDITIONAL has several different forms, including: SERÍAN for 'They would be', SERÍAS for 'You would be', and SERÍAMOS for 'We would be', but the most common by far is 'SERÍA which covers: 'I/HE/SHE/IT/USTED WOULD be'",
				"The next word is SIDO which means BEEN as in 'Have you been a student?', or 'We have been very good friends'",
				"Something weird here is that SIDO is NOT a conjugation, instead it's a form of the verb that doiesn't change based on who we're talking about.",
				"Thing is, in Spanish every verb has lots of CONJUGATED forms which change based on the PERSON who is doing something, but also they will have some forms that NEVER change based on the person who is doing it.",
				"Another example of an UNCONJUGATED form of a verb is the INFINITIVE which we have already learned, SER = TO BE never changes based on the person doing it.",
				"SIDO is called the 'PARTICIPLE' and it's a word we can use to put a verb into the past",
				"We will learnt the word for HAVE soon, but some examples will often include 'have been' which we will translate as 'have SIDO'",
				"There's a third type of UNCONJUGATED verb to learn and this is called the 'GERUND' for SER this word is SIENDO, which roughly means 'BEING', but it's a bit tricky to use.",
				"Specifically, we use SIENDO to emphasize that an action is happening in the PRESENT, or at a PARTICULAR moment, to illustrate imagine instead of talking about 'being' we are talking about 'eating'",
				"Here are some ways the GERUND is used using EATING: 'I am eating', 'She is eating', 'They are eating', 'We are eating', etc.",
				"In each example we changed who is doing the action, but the word EATING doesn't change, instead the word right before eating changes: AM/IS/ARE",
				"Now to use the SER form of the GERUND we would use it in sentences like: 'I am being a good friend' or 'She is being a good friend', or 'They are being a good friend'",
				"The weird thing in each of these cases is that in ENGLISH we use the verb 'to be' twice in a row: 'am being', AM is a form of to be, and SO IS being.",
				"SO the rule is thatr whenever you see this happening you actually have to use a conjugation of ESTAR first, and then the GERUND:",
				"Estoy siendo un buen amigo, Está siendo una buena amiga. Están siendo buenos amigos. Estamos siendo buenos amigos. Estás siendo un buen amigo.",
				"It might seem weird that we are using BOTH ESTAR and SER but the meaning of the sentence is actually only coming from SER, specifically the GERUND: SIENDO, because we are talking about WHAT someone is, they are BEING a good friend.",
				"The verb ESTAR is simply being used along with SIENDO to put emphassis on the present moment, but all the meaning is coming from thbe verb SER, the verb ESTAR is just helping out",
				"SO what is the difference between these two sentences: 'Estás siendo un buen amigo.' and 'Eres un buen amigo.'",
			...
			sentences: [
				...
				},
				{
					...
					data: [
						...
						{
							phrase: "was here",
							translation: [verb.words.estar.past.estaba, advrb.words.aqui],
							reference: ref("estarHowAndWhere"),
						},
						{
							phrase: "has been",
		...
		},
		{
			lesson: 34,
			name: "Lesson 34",
			details: "'This thing', 'That thing', Spanish Noun Genders.",
			info: [
				"Do all nouns have gender? What about when you are talking about ideas that are vague and abstract? Do those ideas have gender as well?",
				"Let's start with some new easy vocabulary: 'COSA' means 'Thing'. This is a feminine noun so it takes feminine articles and pronouns. 'La cosa'",
				"'DIA' means DAY, but this is actually a Masculine noun, despite it ending in A.",
				"ESO which we've learned already meaning that, is a NEUTER word, having no gender. ESO is used generally when no noun is names, but if you are referring to some sort of Speific THAT you would use the genedered pronoun",
				"For example: 'THAT day would be nice' you couldn't use ESO since the THAT we are referring to is a DAY which is Masculine",
				"ESE is the word for THAT which is Masculine, and ESA is the word for THAT which is FEMININE",
				"The Spanish words for 'THIS' are ESTA(F), ESTE(N), and ESTO(M)",
				"These words for THIS and THAT are called Demonstrative Pronouns, since they are used to demonstrate a thing, like you were pointing at it",
				"Remember ESO and ESTO are referring to abstract ideas, and are used by themselves not before or referring to anouther gendered noun.",
			],
			wordBank: [
				pron.demonstrative.words.esto,
				pron.demonstrative.words.ese,
				pron.demonstrative.words.esa,
				pron.demonstrative.words.este,
				pron.demonstrative.words.esta,
				noun.words.cosa,
				noun.words.dia,
			],
		},
